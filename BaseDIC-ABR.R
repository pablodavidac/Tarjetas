...
library("ROCR", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
...
library("reshape2", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
library("arm", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
library("bit64", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
library("plyr", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
library("dplyr", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
library("magrittr", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
library("tree", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
...
muestra<-sample_n(subset(training, Objetivo==0),4995,replace = FALSE)
muestra["filtro"]<-1
...
mod1 <- bayesglm(Objetivo~ 
                 ...
                 , data=Balanceada, family="binomial"(link = "probit"))
...
library("MLmetrics", lib.loc="d:/Users_info/ALBANPD/My Documents/R/R-3.3.0/library")
Gini(fitted.results, as.numeric(testing$Objetivo))
...
####################Deciles###########################
fitted.results <- predict(mod1,newdata=testing,type='response')
View(quantile(fitted.results, prob = seq(0, 1, length = 11), type = 5))
save(DicAbr,file="DiciembreAbrilLimpia.Rdata")

##############Codificacion deciles####################################
